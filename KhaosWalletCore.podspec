...
Pod::Spec.new do |s|
  ...
  s.source = {
    git: 'git@github.com:Khaos-Labs/khaos-wallet-core.git'
  }
  ...
  s.subspec 'Core' do |ss|
    ...
    ss.xcconfig = {
      'HEADER_SEARCH_PATHS' => '$(inherited) ' \
        '${PODS_ROOT}/KhaosWalletCore/src ' \
        '${PODS_ROOT}/KhaosWalletCore/trezor-crypto/src',
      'SYSTEM_HEADER_SEARCH_PATHS' => '$(inherited) ' \
        '/usr/local/include ' \
        '${PODS_ROOT}/KhaosWalletCore/include ' \
        '${PODS_ROOT}/KhaosWalletCore/trezor-crypto/include ' \
        "${PODS_ROOT}/KhaosWalletCore/#{protobuf_source_dir}/src " \
        "${PODS_ROOT}/KhaosWalletCore/#{include_dir} ",
    ...
    ss.dependency 'KhaosWalletCore/Types'
  end
